...
![Добавление глобальной переменной в новый элемент](../../assets/menuap-globalnye_peremennye/02.jpg)

![Добавление глобальной переменной в новый элемент](../../assets/menuap-globalnye_peremennye/03.jpg)

![Добавление глобальной переменной в новый элемент](../../assets/menuap-globalnye_peremennye/04.jpg)

![Примеры использования глобальных переменных](../../assets/menuap-globalnye_peremennye/05.jpg)

<img src="/Tilda-PlanPlace/media/menuap-globalnye_peremennye/06.gif" alt="Примеры использования глобальных переменных" style="max-width:100%;border-radius:8px;" />

![Примеры использования глобальных переменных](../../assets/menuap-globalnye_peremennye/07.png)

<img src="/Tilda-PlanPlace/media/menuap-globalnye_peremennye/08.gif" alt="Примеры использования глобальных переменных" style="max-width:100%;border-radius:8px;" />
