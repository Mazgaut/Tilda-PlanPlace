...
При позиционировании важно, чтобы детали и наполнение не накладывались на фурнитуру. Для этого включается **защита от пересечений** — система не даёт элементам залезать друг в друга. Подробнее — в статье [«Вращение и пересечения моделей»](/Tilda-PlanPlace/vraschenie-i-peresecheniya-modeley/).
