...
Наполнение можно защитить от пересечений с другими элементами — например, чтобы полка не наложилась на петлю или направляющую. Это настраивается через параметры пересечений (см. [«Вращение и пересечения моделей»](/Tilda-PlanPlace/vraschenie-i-peresecheniya-modeley/)) и делает конструкцию «умной»: элементы не залезают друг в друга.
